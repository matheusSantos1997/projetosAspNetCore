...
namespace Pensamentos.Shared
{
    ...
    public class ApiController : ControllerBase
    {
        ...
        protected new JsonResult ResponseResult(HttpStatusCode statusCode, object? data, string? errorMessage)
        {
        ...
        protected new JsonResult ResponseResult(HttpStatusCode statusCode, object result) => ResponseResult(statusCode, result, null);


        protected new JsonResult ResponseResult(HttpStatusCode statusCode, string errorMessage) => ResponseResult(statusCode, null, errorMessage);


        protected new JsonResult ResponseResult(HttpStatusCode statusCode) => ResponseResult(statusCode, null, null);
    }
}
