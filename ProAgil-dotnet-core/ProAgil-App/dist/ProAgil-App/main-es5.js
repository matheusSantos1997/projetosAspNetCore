...
/* harmony import */ var ngx_currency__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ngx-currency */ "./node_modules/ngx-currency/fesm5/ngx-currency.js");
...
var AuthInterceptor = /** @class */ (function () {
    ...
    AuthInterceptor.prototype.intercept = function (req, next) {
        ...
        if (localStorage.getItem('token') !== null) {
            ...
            return next.handle(cloneReq).pipe(Object(rxjs_internal_operators_tap__WEBPACK_IMPORTED_MODULE_3__["tap"])(function (success) { }, function (error) {
                if (error.status === 401) {
...
var EventoComponent = /** @class */ (function () {
    function EventoComponent(toastr, eventoService, modalService, fb, localeService) {
        this.toastr = toastr;
    ...
    Object.defineProperty(EventoComponent.prototype, "filtroLista", {
    ...
    EventoComponent.prototype.editarEvento = function (evento, template) {
        this.modoSalvar = 'put';
    ...
    EventoComponent.prototype.novoEvento = function (template) {
        this.modoSalvar = 'post';
        this.openModal(template);
    };
    // excluir Evento
    EventoComponent.prototype.excluirEvento = function (evento, template) {
        this.openModal(template);
        this.evento = evento;
        this.bodyDeletarEvento = "Tem certeza que deseja excluir o Evento: " + evento.tema + ", C\u00F3digo: " + evento.id;
    };
    EventoComponent.prototype.confirmeDelete = function (template) {
        var _this = this;
        this.eventoService.deleteEvento(this.evento.id).subscribe(function () {
            ...
            _this.toastr.error("Erro ao deletar: " + error);
            // console.log(error);
        });
    };
    EventoComponent.prototype.openModal = function (template) {
    ...
    EventoComponent.prototype.filtrarEventos = function (filtrarPor) {
    ...
    EventoComponent.prototype.alternarImagem = function () {
        this.mostrarImagem = !this.mostrarImagem; // vai fazer com que as imagens suma da tela
    };
    EventoComponent.prototype.validation = function () {
    ...
    EventoComponent.prototype.onFileChange = function (event) {
        var reader = new FileReader(); // vai ler a imagem selecionada
        if (event.target.files && event.target.files.length) {
            this.file = event.target.files;
            console.log(this.file);
        }
    };
    EventoComponent.prototype.uploadImagem = function () {
        var _this = this;
        if (this.modoSalvar === 'post') {
            ...
            this.eventoService.postUpload(this.file, nomeArquivo[2]).subscribe(function () {
                ...
                _this.getEventos(); // recarrega a pagina automaticamente
            });
        }
        else {
            this.evento.imagemUrl = this.fileNameToUpdate; // mantem o nome na imagem
            this.eventoService.postUpload(this.file, this.fileNameToUpdate).subscribe(function () {
                _this.dataAtual = new Date().getMilliseconds().toString();
            });
        }
    };
    // salva as alteraçoes apos inserir novos registros na base de dados
    EventoComponent.prototype.salvarAlteracao = function (template) {
        var _this = this;
        ...
        if (this.registerForm.valid) {
            if (this.modoSalvar === 'post') {
                ...
                this.eventoService.postEvento(this.evento).subscribe(function (novoEvento) {
                    ...
                    template.hide();
                    _this.getEventos(); // vai atualizar com os novos eventos inseridos
    ...
    EventoComponent.prototype.getEventos = function () {
        var _this = this;
        this.dataAtual = new Date().getMilliseconds().toString();
        /* this.eventos = this.http.get('http://localhost:5000/api/values'); */
        this.dataAtual = new Date().getMilliseconds().toString();
        this.eventoService.getAllEvento().subscribe(function (eventos) {
    ...
    EventoComponent.ctorParameters = function () { return [
...
var EventoEditComponent = /** @class */ (function () {
    function EventoEditComponent(toastr, eventoService, fb, router, route, localeService) {
        this.toastr = toastr;
        this.eventoService = eventoService;
        this.fb = fb;
        this.router = router;
    ...
    EventoEditComponent.prototype.carregarEvento = function () {
        var _this = this;
        var idEvento = +this.router.snapshot.paramMap.get('id'); // + converte uma string para number
    ...
    EventoEditComponent.prototype.uploadImagem = function () {
        ...
        if (this.registerForm.get('imagemUrl').value !== '') {
            this.eventoService.postUpload(this.file, this.fileNameToUpdate)
                ...
                _this.dataAtual = new Date().getMilliseconds().toString();
                location.reload();
                _this.imagemUrl = "http://localhost:5000/Resources/images/" + _this.evento.imagemUrl + "?_ts=" + location.reload();
            });
        }
    };
    // botao voltar para todos os eventos em geral
    EventoEditComponent.prototype.backToGeneralEvents = function () {
        this.route.navigate(['/evento']);
    };
    EventoEditComponent.ctorParameters = function () { return [
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(authServices, router, toastr) {
    ...
    LoginComponent.prototype.login = function () {
        ...
        this.authServices.login(this.model)
            .subscribe(function () {
            _this.router.navigate(['/dashboard']); // redireciona para a pagina de dashboard
            _this.toastr.success('Logado com Sucesso!');
        }, function (error) {
            _this.toastr.error("Falha ao tentar Logar, usu\u00E1rio ou senha incorreto " + error);
        });
    };
...
var RegistrationComponent = /** @class */ (function () {
    function RegistrationComponent(authServices, router, fb, toastr) {
        this.authServices = authServices;
        this.router = router;
        this.fb = fb;
        this.toastr = toastr;
    ...
    RegistrationComponent.prototype.cadastrarUsuario = function () {
        ...
        if (this.registerForm.valid) {
            ...
            this.authServices.register(this.user).subscribe(function () {
                _this.router.navigate(['/user/login']);
                _this.toastr.success('Cadastrado Realizado com Sucesso!');
            }, function (error) {
