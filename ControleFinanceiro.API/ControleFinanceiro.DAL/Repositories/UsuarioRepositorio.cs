...
namespace ControleFinanceiro.DAL.Repositories
{
    public class UsuarioRepositorio : RepositorioGenerico<Usuario>, IUsuarioRepositorio
    {
        ...
        private readonly UserManager<Usuario> _gerenciadorUsuarios; // gerenciamento de usuario
        private readonly SignInManager<Usuario> _gerenciadorLogin; // login de usuarios
